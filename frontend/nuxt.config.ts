...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      ...
      // ==============================================
      // Theme Runtime Config (grayscale palette)
      useDark: Boolean(process.env.THEME_USE_DARK) || false,
      themes: {
        dark: {
          primary: process.env.THEME_DARK_PRIMARY || "#FAFAFA",
          accent: process.env.THEME_DARK_ACCENT || "#E0E0E0",
          secondary: process.env.THEME_DARK_SECONDARY || "#BDBDBD",
          success: process.env.THEME_DARK_SUCCESS || "#9E9E9E",
          info: process.env.THEME_DARK_INFO || "#757575",
          warning: process.env.THEME_DARK_WARNING || "#BDBDBD",
          error: process.env.THEME_DARK_ERROR || "#FFFFFF",
          background: "#1E1E1E",
        },
        light: {
          primary: process.env.THEME_LIGHT_PRIMARY || "#212121",
          accent: process.env.THEME_LIGHT_ACCENT || "#424242",
          secondary: process.env.THEME_LIGHT_SECONDARY || "#616161",
          success: process.env.THEME_LIGHT_SUCCESS || "#4F4F4F",
          info: process.env.THEME_LIGHT_INFO || "#757575",
          warning: process.env.THEME_LIGHT_WARNING || "#9E9E9E",
          error: process.env.THEME_LIGHT_ERROR || "#000000",
        },
      },
    },
  },
